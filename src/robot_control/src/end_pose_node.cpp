...
private:
    ...
    rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr publisher_; ///< Publisher for the end-effector pose.
    tf2_ros::Buffer tf_buffer_; ///< TF2 buffer for storing transforms.
    tf2_ros::TransformListener tf_listener_; ///< TF2 listener to receive transforms.
    rclcpp::TimerBase::SharedPtr timer_; ///< Timer to periodically publish the pose.
};
